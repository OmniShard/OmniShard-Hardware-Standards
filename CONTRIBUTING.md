...
Chào mừng các đối tác và nhà phát triển quan tâm đến hệ sinh thái **OmniShard**. Để đảm bảo tính toàn vẹn của giao thức **Mật mã phân mảnh Omni (Omni-Sharding)** và an toàn cho liên minh, mọi đóng góp phải tuân thủ quy trình nghiêm ngặt dưới đây.
...
* **Quyền quyết định:** Mọi thay đổi liên quan đến logic chia mảnh khóa, thuật toán đồng thuận ngưỡng và giao thức kết nối Peer-to-Peer phải được phê duyệt trực tiếp bởi **OmniShard Architect**.
* **Tính bảo mật:** Không chấp nhận bất kỳ mã nguồn nào có dấu hiệu tạo ra "Backdoor" hoặc làm suy yếu ngưỡng bảo mật.
...
* Nó có làm thay đổi cơ chế nắm giữ mảnh khóa của 10 bên liên minh không?
...
* **Kiểm toán (Auditing):** Architect sẽ tiến hành kiểm tra mã nguồn (Code Review) thủ công từng dòng để đảm bảo không có mã độc.
...
3. **Thỏa thuận Vận hành:** Ký cam kết không tự ý Fork mã nguồn để tạo ra các biến thể làm mất tính thống nhất của liên minh.

---

## 🚫 Các hành vi bị nghiêm cấm
* Tự ý thay đổi cấu hình `Orderer` hoặc `MSP` mà không thông qua đồng thuận liên minh.
* Chèn các đoạn mã nhằm thu thập trái phép mảnh khóa từ các Peer khác.
* Sử dụng tên gọi **OmniShard** cho các sản phẩm phái sinh không được tác giả cấp phép.

---
**"Sự an toàn của liên minh nằm trong tay sự kỷ luật của mỗi thành viên."**
*— OmniShard Architect*
